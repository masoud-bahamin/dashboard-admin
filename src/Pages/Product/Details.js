                        ...
                        <div className='bg-white p-4 rounded-25p shadow-sm mb-4'>
                            ...
                            {tab === "1" ? (
                                ...
                                <div className='py-2'>
                                    ...
                                    <div class="input-group  rounded-25p bg-l border mt-4 align-items-center d-flex">
                                        <input type="text" class="form-control border-none rounded-25p bg-l fs-12" placeholder="Add a comment" />
                                        <button class="btn btn-outline-secondary bg-gold4 text-white rounded-25p border-none" >
                                            Send
                                        </button>
                                    </div>
                                </div>
